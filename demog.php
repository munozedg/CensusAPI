...
if (isset($_GET['sumlev'])){$sumlev = make_safe($_GET['sumlev']);}
...
if (isset($_GET['geo'])){$geo = make_safe($_GET['geo']);}
if (isset($_GET['series'])){$series = make_safe($_GET['series']);}
if (isset($_GET['type'])){$type = make_safe($_GET['type']);}
...
//push $_GET vars into simple array for each $key
...
if (!(isset($_GET['table'])) && !(isset($_GET['field']))){array_push($errorarray, 'You need to specify a table or fields to query.'); goto a;}

  //as far as errors go, tell people they are wasting their time specifying table(s) if they specified field.
if (isset($field)){
if (isset($_GET['table'])){array_push($errorarray, 'You specified TABLE.  This parameter is ignored when you also specify FIELD');};
}
...
if (isset($_GET['state'])){array_push($errorarray, 'You specified STATE.  This parameter is ignored when you also specify GEONUM');};
if (isset($_GET['county'])){array_push($errorarray, 'You specified COUNTY.  This parameter is ignored when you also specify GEONUM');};
if (isset($_GET['sumlev'])){array_push($errorarray, 'You specified SUMLEV.  This parameter is ignored when you also specify GEONUM');};
if (isset($_GET['geoid'])){array_push($errorarray, 'You specified GEOID.  This parameter is ignored when you also specify GEONUM');};
...
//CASE 2:  you have a geoid
  ...
  //as far as errors go, tell people they are wasting their time specifying sumlev, state, county, place and geoid if they specified geonum.
if (isset($_GET['state'])){array_push($errorarray, 'You specified STATE.  This parameter is ignored when you also specify GEOID');};
if (isset($_GET['county'])){array_push($errorarray, 'You specified COUNTY.  This parameter is ignored when you also specify GEOID');};
if (isset($_GET['sumlev'])){array_push($errorarray, 'You specified SUMLEV.  This parameter is ignored when you also specify GEOID');};
