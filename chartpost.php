...
//$GET Variables
if (isset($_POST['geonum'])){$geonum = make_safe($_POST['geonum']);} 
if (isset($_POST['table'])){$table = make_safe($_POST['table']);} 
if (isset($_POST['numerator'])){$numerator = make_safe($_POST['numerator']);} 
if (isset($_POST['denominator'])){$denominator = make_safe($_POST['denominator']);} 
